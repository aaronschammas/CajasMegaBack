...
func SetupRoutes(cfg *config.Config) *gin.Engine {
	...
	protected.Use(middleware.AuthMiddleware()) // Verificar autenticación
	{
		...
		// Arco avanzado: permite caja propia y mantiene compatibilidad con vista global admin
		protected.POST("/arco/abrir-avanzado",
			middleware.RequirePermission(middleware.PermOpenOwnArco, middleware.PermOpenGlobalArco),
		...
		protected.GET("/api/movimientos/global",
			middleware.RequirePermission(middleware.PermReadAllMovement, middleware.PermViewGlobalCaja),
